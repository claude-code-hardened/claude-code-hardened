...
export async function processBashCommand(
  ...
  try {
    ...
    type PSMod = typeof import('@claude-code-hardened/builtin-tools/tools/PowerShellTool/PowerShellTool.js');
    let PowerShellTool: PSMod['PowerShellTool'] | null = null;
    if (usePowerShell) {
      /* eslint-disable @typescript-eslint/no-require-imports */
      PowerShellTool = (require('@claude-code-hardened/builtin-tools/tools/PowerShellTool/PowerShellTool.js') as PSMod)
        .PowerShellTool;
