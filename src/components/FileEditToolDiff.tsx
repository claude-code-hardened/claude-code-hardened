...
import type { FileEdit } from '@claude-code-hardened/builtin-tools/tools/FileEditTool/types.js';
import { findActualString } from '@claude-code-hardened/builtin-tools/tools/FileEditTool/utils.js';
