...
import { getActiveAgentsFromList } from '@claude-code-hardened/builtin-tools/tools/AgentTool/loadAgentsDir.js';
import { clearAgentDefinitionsCache } from '@claude-code-hardened/builtin-tools/tools/AgentTool/loadAgentsDir.js';
