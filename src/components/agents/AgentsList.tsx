...
import type { ResolvedAgent } from '@claude-code-hardened/builtin-tools/tools/AgentTool/agentDisplay.js';
import {
  AGENT_SOURCE_GROUPS,
  compareAgentsByName,
  getOverrideSourceLabel,
  resolveAgentModelDisplay,
} from '@claude-code-hardened/builtin-tools/tools/AgentTool/agentDisplay.js';
