...
import type { AgentDefinitionsResult } from '@claude-code-hardened/builtin-tools/tools/AgentTool/loadAgentsDir.js';
import type {
  AssistantMessage,
...
const SEND_USER_FILE_TOOL_NAME: string | null = feature('KAIROS')
  ? (
      require('@claude-code-hardened/builtin-tools/tools/SendUserFileTool/prompt.js') as typeof import('@claude-code-hardened/builtin-tools/tools/SendUserFileTool/prompt.js')
